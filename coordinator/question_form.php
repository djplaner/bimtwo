 ...
 *   and delete questions for a bimtwo activity
...
class bimtwo_question_form extends moodleform {
    ...
    function definition() {
        ...
        $button_array[] = &$mform->createElement( 'submit', 'submitbutton',
                            get_string( 'qform_submit', 'bimtwo' ) );
        $button_array[] = &$mform->createElement( 'cancel', 'cancelbutton',
                                   get_string( 'qform_cancel', 'bimtwo' ) );
        ...
        foreach ( $questions as $question ) {
            $mform->addElement('header', $question->id, 
                   get_string( 'qform_question', 'bimtwo', $question->title ) );
            // add the stats
            ...
            $mform->addElement( 'html', get_string( 'qform_stats', 'bimtwo', 
                                           $stats ) );
          ...
          $mform->addElement( 'html', '</td><th>' .
                       get_string( 'qform_delete', 'bimtwo' ) . '</th><td>' );
